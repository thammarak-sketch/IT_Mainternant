...
const Layout = () => {
    ...
    return (
        <div className="flex min-h-screen bg-gray-100">
            ...
            <div className="lg:hidden fixed top-0 left-0 right-0 bg-slate-800 text-white p-4 z-20 flex justify-between items-center shadow-md">
            ...
            {/* Main Content */}
            <div className="flex-1 lg:ml-64 p-4 lg:p-8 pt-20 lg:pt-8 pb-20 lg:pb-8 transition-all duration-300">
                <main>
                    <Outlet />
                </main>
            </div>
